...
public class DeleteNode {
     ...
     * the next pointer of that node in any way. Instead, we have to replace the value of the node
     * we want to delete with the value in the node after it, and then delete the node after it.
     * <p>
     ...
     * </p>
     *
     * @param node ListNode to be deleted
     */
